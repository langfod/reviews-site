...
@Configuration
public class SampleReviewFactory {

	@Bean
	public Collection<Review> sampleReviewList() {

		Collection<Review> out = new ArrayList<>();

		out.add(new Review(createId(), "Tour", "war stuff",
				...
				Arrays.asList("war", "graphic novels", "book", "fiction")));
		// gimmeURL("https://farm5.staticflickr.com/4119/4924453496_b4d39c2cd8_m_d.jpg"),
		out.add(new Review(createId(), "A Discovery of New Worlds", "astronomy", "March 21, 2017\r\n"
				+ "Format: Paperback\r\n"
				...
				Arrays.asList("translated", "astronomy", "french", "book", "nonfiction")));
		// gimmeURL("https://farm9.staticflickr.com/8330/8083124491_e49d85055b_m_d.jpg"),
		out.add(new Review(createId(), "Fifty Specialty Libraries of New York City: From Botany to Magic ", "cities",
				...
				"img/20096881228_03ef098231_m.jpg", Arrays.asList("nonfiction", "book", "new york city")));
		// gimmeURL("https://farm1.staticflickr.com/310/20096881228_03ef098231_m_d.jpg"),
		out.add(new Review(createId(), "Bacon", "yummy bacon",
				...
				LocalDate.now(), "Using Bacon Ipsum to test", gimmeURL("https://baconmockup.com/200/250/"),
				Arrays.asList("bacon", "meat", "tasty")));
		out.add(new Review(createId(), "Small Furry Kittens", "meow", "Birman egyptian mau\r\n"
				...
				LocalDate.now(), "Kitten Ipsum for testing", gimmeURL("http://placekitten.com/200/250"),
				Arrays.asList("cute", "furry", "meat", "scratches")));
		out.add(new Review(createId(), "Bill Murray", "actors", "From Wikipedia, the free encyclopedia\r\n" + "\r\n"
				+ "\r\n"
				...
				gimmeURL("http://www.fillmurray.com/200/250"), Arrays.asList("actor", "groundhog-catcher")));
	...
	private static URL gimmeURL(String urlStr) {
		URL url = null;
		try {
			url = new URL(urlStr);
